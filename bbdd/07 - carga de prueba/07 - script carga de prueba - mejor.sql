...
insert into dominio (id, descripcion) values ('WBAKG1C58DJ362995', 'Mercedes-Benz GLK-Class 2010 Mauv');
insert into dominio (id, descripcion) values ('WAUUL78E87A597689', 'Jeep Compass 2010 Aquamarine');
insert into dominio (id, descripcion) values ('3GYFNDE3XCS841790', 'Honda Ridgeline 2010 Crimson');
insert into dominio (id, descripcion) values ('1GD12YEG7FF255314', 'Plymouth Neon 1998 Teal');
insert into dominio (id, descripcion) values ('5YMGY0C55BL776924', 'Aston Martin Rapide 2012 Yellow');
insert into dominio (id, descripcion) values ('JN8AF5MR4FT811577', 'Pontiac Vibe 2003 Aquamarine');
insert into dominio (id, descripcion) values ('WAUFFAFC8DN761865', 'Honda Element 2003 Purple');
insert into dominio (id, descripcion) values ('1N6AD0CU9FN913856', 'Ford E250 2006 Fuscia');
insert into dominio (id, descripcion) values ('1G4GA5GR1DF365623', 'Suzuki Aerio 2006 Green');
insert into dominio (id, descripcion) values ('4JGCB2FE9AA432602', 'Chevrolet Traverse 2009 Khaki');
insert into dominio (id, descripcion) values ('5TDBW5G11FS056022', 'Mercedes-Benz 500SEL 1993 Mauv');
insert into dominio (id, descripcion) values ('1HGCP2F31BA033061', 'Mazda MX-6 1992 Indigo');
insert into dominio (id, descripcion) values ('1G6DP57V990778194', 'Dodge Caravan 2010 Mauv');
insert into dominio (id, descripcion) values ('JTDKTUD3XED331552', 'Honda CR-V 2011 Red');
insert into dominio (id, descripcion) values ('1NXBU4EE0AZ728996', 'Honda Insight 2012 Violet');
insert into dominio (id, descripcion) values ('WBALM7C50EJ481786', 'Honda Pilot 2004 Goldenrod');
insert into dominio (id, descripcion) values ('WAUSF78E86A955810', 'Nissan 350Z 2006 Blue');
insert into dominio (id, descripcion) values ('WA1WKAFP7BA756222', 'Mitsubishi Challenger 2000 Goldenrod');
insert into dominio (id, descripcion) values ('JH4CU4F43BC700470', 'Jaguar S-Type 2004 Blue');
insert into dominio (id, descripcion) values ('WVGAK7A98AD752684', 'Ford E250 2003 Fuscia');
insert into dominio (id, descripcion) values ('5UXFG83569L636220', 'Ford Festiva 1988 Violet');
insert into dominio (id, descripcion) values ('JTHBE1D25E5380442', 'Ford Mustang 1991 Orange');
insert into dominio (id, descripcion) values ('5GTMNGEE2A8807003', 'Chevrolet Monte Carlo 2005 Violet');
insert into dominio (id, descripcion) values ('WA1DMAFP4EA694431', 'Mercury Cougar 1996 Teal');
insert into dominio (id, descripcion) values ('2FMGK5BC6BB921520', 'Lexus LS 1994 Turquoise');
insert into dominio (id, descripcion) values ('WAUSF98E08A618367', 'Mazda Mazda6 2007 Khaki');
insert into dominio (id, descripcion) values ('5FRYD4H95GB896243', 'Scion tC 2007 Green');
insert into dominio (id, descripcion) values ('WAUKFAFL2DN755509', 'Toyota Highlander 2007 Green');
insert into dominio (id, descripcion) values ('JH4CU2F62BC972398', 'Mazda MPV 1993 Crimson');
insert into dominio (id, descripcion) values ('1FTMF1E82AF941658', 'Mitsubishi Galant 1993 Pink');
insert into dominio (id, descripcion) values ('3VW1K7AJ2DM396091', 'Ford Probe 1991 Green');
insert into dominio (id, descripcion) values ('JTDJTUD37ED994296', 'Infiniti J 1995 Puce');
insert into dominio (id, descripcion) values ('WP0AA2A91AS695721', 'Honda Prelude 1999 Mauv');
insert into dominio (id, descripcion) values ('1FADP5AU9FL039128', 'Buick Century 2002 Yellow');
insert into dominio (id, descripcion) values ('JHMZF1C69CS136579', 'Maybach 62 2004 Puce');
insert into dominio (id, descripcion) values ('YV4852CT4B1073730', 'Buick LeSabre 2003 Aquamarine');
insert into dominio (id, descripcion) values ('WAUSGCFC2CN565877', 'Mercedes-Benz E-Class 2004 Purple');
insert into dominio (id, descripcion) values ('KNAFX6A83F5565302', 'Subaru Brat 1985 Orange');
insert into dominio (id, descripcion) values ('JN8AS5MT6BW380644', 'Maserati 430 1990 Crimson');
insert into dominio (id, descripcion) values ('1N6AA0CA7CN577568', 'Ferrari 458 Italia 2012 Orange');
insert into dominio (id, descripcion) values ('1G6DH5E52D0497945', 'Mazda MPV 1998 Violet');
insert into dominio (id, descripcion) values ('3VW4A7AT3DM018914', 'Ford F250 1984 Red');
insert into dominio (id, descripcion) values ('WBAHN03518D429161', 'Toyota Echo 2001 Crimson');
insert into dominio (id, descripcion) values ('3C6LD4BT2CG162607', 'Lamborghini Gallardo 2005 Green');
insert into dominio (id, descripcion) values ('5FRYD3H82FB671133', 'Land Rover Discovery 2012 Turquoise');
insert into dominio (id, descripcion) values ('3C3CFFCR4FT846818', 'Mercedes-Benz SL-Class 2008 Mauv');
insert into dominio (id, descripcion) values ('JTJYWRBZ1F2641833', 'Jaguar XJ Series 1993 Blue');
insert into dominio (id, descripcion) values ('WDDEJ7HBXAA398658', 'Chevrolet Astro 2005 Violet');
insert into dominio (id, descripcion) values ('WBAYF8C53FD405713', 'Chevrolet Tahoe 2009 Orange');
insert into dominio (id, descripcion) values ('SALAB2D42DA779739', 'BMW 745 2004 Violet');
insert into dominio (id, descripcion) values ('WAUHE78P38A894190', 'GMC Savana 1500 1996 Purple');
insert into dominio (id, descripcion) values ('1G6AB5RA0D0060523', 'Ford Galaxie 1966 Orange');
insert into dominio (id, descripcion) values ('1C4SDJCT4CC694865', 'Bentley Arnage 2008 Aquamarine');
insert into dominio (id, descripcion) values ('WA1VMAFE6CD167411', 'Subaru Outback 2004 Fuscia');
insert into dominio (id, descripcion) values ('KMHTC6AD6FU540586', 'Kia Sephia 1997 Teal');
insert into dominio (id, descripcion) values ('WBAKG1C55DJ024356', 'Subaru Loyale 1993 Red');
insert into dominio (id, descripcion) values ('JTHSE5BC2F5877128', 'Ram 3500 2012 Aquamarine');
insert into dominio (id, descripcion) values ('WDDHF2EBXCA944836', 'Ford Explorer 2000 Yellow');
insert into dominio (id, descripcion) values ('1FTEW1CM8EK301665', 'Chevrolet Express 3500 2006 Orange');
insert into dominio (id, descripcion) values ('5N1AZ2MH3FN575173', 'Lexus GX 2010 Violet');
insert into dominio (id, descripcion) values ('WAUAFAFL0DN825343', 'Honda CR-V 1997 Blue');
insert into dominio (id, descripcion) values ('WA1LGAFE7ED753391', 'Mazda Mazda2 2011 Orange');
insert into dominio (id, descripcion) values ('3D7TT2CT4AG274990', 'Toyota Supra 1995 Teal');
insert into dominio (id, descripcion) values ('3C6TD4KT5CG808612', 'Infiniti M 1992 Turquoise');
insert into dominio (id, descripcion) values ('WP0AA2A91DS328905', 'Lamborghini Gallardo 2006 Purple');
insert into dominio (id, descripcion) values ('3VWML7AJ1EM773263', 'GMC Savana 2500 2009 Orange');
insert into dominio (id, descripcion) values ('WAULD64B03N699201', 'Mitsubishi Montero Sport 1999 Mauv');
insert into dominio (id, descripcion) values ('WAUBGAFB9BN248351', 'Mercedes-Benz CL-Class 2001 Orange');
insert into dominio (id, descripcion) values ('WBAEN33455E913237', 'Mitsubishi Mighty Max 1995 Purple');
insert into dominio (id, descripcion) values ('WBA6A0C58DD673578', 'Cadillac Escalade EXT 2007 Goldenrod');
insert into dominio (id, descripcion) values ('1GYS4EEJ4DR958579', 'Ford Bronco 1986 Green');
insert into dominio (id, descripcion) values ('JHMZE2H37DS653551', 'Buick LeSabre 2000 Indigo');
insert into dominio (id, descripcion) values ('JN8AZ1MU8EW845880', 'Oldsmobile Bravada 1994 Turquoise');
insert into dominio (id, descripcion) values ('WAUDF98E48A231023', 'Ford Aerostar 1994 Mauv');
insert into dominio (id, descripcion) values ('SCFFDABEXAG683428', 'BMW Z3 2002 Aquamarine');
insert into dominio (id, descripcion) values ('2HNYD18235H232804', 'Volkswagen Fox 1992 Red');
insert into dominio (id, descripcion) values ('SCBDR3ZA5AC329090', 'Mitsubishi Eclipse 1995 Pink');
insert into dominio (id, descripcion) values ('2FMDK3AC8AB940688', 'Toyota Camry 2011 Turquoise');
insert into dominio (id, descripcion) values ('1GD02ZCG7DF799264', 'Ford Explorer 2011 Goldenrod');
insert into dominio (id, descripcion) values ('JTDZN3EU9FJ131940', 'Cadillac Escalade 2006 Khaki');
insert into dominio (id, descripcion) values ('1FMHK7B8XBG954704', 'Mitsubishi Mirage 1990 Purple');
insert into dominio (id, descripcion) values ('YV4952CZ8E1622486', 'Mercedes-Benz CLK-Class 2005 Khaki');
insert into dominio (id, descripcion) values ('WAULT58E75A014686', 'Lexus RX 2003 Orange');
insert into dominio (id, descripcion) values ('WAUFEAFM5BA724286', 'Volvo S40 2000 Violet');
insert into dominio (id, descripcion) values ('1D7RV1GT1BS197465', 'Mitsubishi Montero 2004 Turquoise');
insert into dominio (id, descripcion) values ('JM3TB2CA0E0525503', 'Chevrolet Cobalt 2009 Mauv');
insert into dominio (id, descripcion) values ('WBADN63403G220462', 'Dodge Ram 2500 Club 1998 Goldenrod');
insert into dominio (id, descripcion) values ('19UUA66294A059866', 'Dodge Caravan 1998 Orange');
insert into dominio (id, descripcion) values ('1G6DJ5EY0B0791694', 'Mercedes-Benz GL-Class 2011 Violet');
insert into dominio (id, descripcion) values ('1FMJK1J5XAE261373', 'Cadillac DeVille 1999 Violet');
insert into dominio (id, descripcion) values ('WAULT68E42A051017', 'Cadillac STS 2005 Mauv');
insert into dominio (id, descripcion) values ('1GKS2GEJ2BR910880', 'Ford F150 1984 Khaki');
insert into dominio (id, descripcion) values ('5XXGM4A77DG062232', 'Lincoln Town Car 1988 Aquamarine');
insert into dominio (id, descripcion) values ('2HNYD28537H570464', 'Ford Econoline E350 1997 Orange');
insert into dominio (id, descripcion) values ('2G4GR5GX9F9169965', 'Honda Ridgeline 2011 Maroon');
insert into dominio (id, descripcion) values ('1FTWX3B58AE631239', 'Saturn VUE 2007 Mauv');
insert into dominio (id, descripcion) values ('5UXFA93574L165341', 'Lincoln Navigator 2004 Indigo');
insert into dominio (id, descripcion) values ('JTHBK1GG9D1535838', 'Honda Prelude 1997 Green');
insert into dominio (id, descripcion) values ('WAUDG78E25A107488', 'Ford F250 1999 Indigo');
insert into dominio (id, descripcion) values ('KL4CJASB5EB594685', 'Mazda Miata MX-5 2012 Mauv');
